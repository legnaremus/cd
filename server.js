          ...
          execute_query(query_final,function(todos){
            ...
            if (req.params['monto']){
              ...
              execute_query(query3,function(todos) {
                ...
                if (req.params['ticket'] == undefined){
                  query2 = 'INSERT INTO "Transaccion"(id_monedero, id_sucursal, id_usuario, fecha_transaccion, monto,alerta) VALUES(!id!, !id_sucursal!, !id_usuario!,'  + "'" +  new Date()+ "'" + ' , !monto!, ' + alerta + ' ) returning id_transaccion';
                }else{
                  query2 = 'INSERT INTO "Transaccion"(id_transaccion,id_monedero, id_sucursal, id_usuario, fecha_transaccion, monto,alerta) VALUES('+req.params['ticket']+',!id!, !id_sucursal!, !id_usuario!,'  + "'" +  new Date()+ "'" + ' , !monto!, ' + alerta + ' ) returning id_transaccion';
                }
